...
def Test_DFastICA():
    c1,_ = MIV_Load(r'testdata/c1.miv')
    c2,_ = MIV_Load(r'testdata/c2.miv')
    c3,d = MIV_Load(r'testdata/c3.miv')
...
def Test_Stack_DFastICA():
    c1,_ = MIV_Load(r'testdata/s1.miv')
    c2,_ = MIV_Load(r'testdata/s2.miv')
    c3,d = MIV_Load(r'testdata/s3.miv')
    print "Stack size =", d
    Dx = np.vstack((c1.ravel(), c2.ravel(), c3.ravel()))
    fica = DFastICA()
